...
public class DLL<T> {
  ...
  public void addLast(T v) {
    if (tail==null) {
      ...
      tail.setNext(new BinaryTree<T>(v,tail,null));
      tail = tail.getNext();
    }
  }
  ...
  public void addAfter(BinaryTree<T> here, T v) {
    if (here == null) {
      ...
      here.setNext(new BinaryTree<T>(v,here,here.getNext()));
  ...
  public void appendCopy(DLL<T> suffix) {
      if (suffix.head != null) {  // do nothing if suffix empty
          if (head == null) {  // copy first element
              ...
              tail.setNext(new BinaryTree<T>(suffix.head.getData(),tail,null));
              tail = tail.getNext();
          }
          // make copies of remaining nodes
          BinaryTree<T> pos = suffix.head;
          for (pos = pos.getNext(); pos != null; pos = pos.getNext()) {
              tail.setNext(new BinaryTree<T>(pos.getData(),tail,null));
              tail = tail.getNext();
          }            
      }
  }
  ...
  public void insertAfter(BinaryTree<T> pos, T c) {
      pos.setNext(new BinaryTree<T>(c,pos,pos.getNext()));
